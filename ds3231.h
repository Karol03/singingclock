...
#define Y2K_UNIX_EPOCH_DIFF 946684800llu
#define YEARS (uint64_t(__DATE__[10] - '0' + (__DATE__[9] - '0') * 10llu))
#define DAY_OF_MONTH ((__DATE__[5] - '0') \
                  + (((__DATE__[4] > '0')? __DATE__[4] - '0': 0llu) * 10llu))
#define DAY_OF_YEAR ((DAY_OF_MONTH) + \
( /* Jan */ (__DATE__[0] == 'J' && __DATE__[1] == 'a')?   0llu: \
  /* Feb */ (__DATE__[0] == 'F'                      )?  31llu: \
  /* Mar */ (__DATE__[0] == 'M' && __DATE__[2] == 'r')?  59llu: \
  /* Apr */ (__DATE__[0] == 'A' && __DATE__[1] == 'p')?  90llu: \
  /* May */ (__DATE__[0] == 'M'                      )? 120llu: \
  /* Jun */ (__DATE__[0] == 'J' && __DATE__[2] == 'n')? 151llu: \
  /* Jul */ (__DATE__[0] == 'J'                      )? 181llu: \
  /* Aug */ (__DATE__[0] == 'A'                      )? 212llu: \
  /* Sep */ (__DATE__[0] == 'S'                      )? 243llu: \
  /* Oct */ (__DATE__[0] == 'O'                      )? 273llu: \
  /* Nov */ (__DATE__[0] == 'N'                      )? 304llu: \
  /* Dec */                                             334llu  ))
#define LEAP_DAYS (YEARS / 4llu + ((YEARS % 4llu == 0llu && DAY_OF_YEAR > 58llu)? 1llu : 0llu) )      
#define __DATE_TIME_Y2K__ ( (YEARS * 365llu + LEAP_DAYS + DAY_OF_YEAR ) * 86400llu \
                    + ((__TIME__[0] - '0') * 10llu + __TIME__[1] - '0') * 3600llu \
                    + ((__TIME__[3] - '0') * 10llu + __TIME__[4] - '0') * 60llu \
                    + ((__TIME__[6] - '0') * 10llu + __TIME__[7] - '0') )
